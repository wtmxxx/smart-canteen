 ...
 * Author: liebin.zheng
 * Generate Date: 2025-05-31 17:18:35
 */
package tgy2.cosmic.debug;
...
//    	Thread.currentThread().setContextClassLoader(new KDSecurityClassLoader(Thread.currentThread().getContextClassLoader()));
        ...
        cosmic.setConfigUrl("10.1.0.5:2181?user=zookeeper&password=zookeeper1005");
//        cosmic.setConfigUrl("10.1.0.5:2181");

//        cosmic.setMcServerUrl("http://127.0.0.1:8090");
        cosmic.setMcServerUrl("http://10.1.0.5:8090"); 
